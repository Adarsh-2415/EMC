...
import { X, Building2, Mail, Phone, MapPin, Award, Calendar, FileText } from 'lucide-react'

export interface OnlineApplicationRecord {
  id: string
  company_name: string
  address: string
...
interface ApplicationDetailModalProps {
  application: OnlineApplicationRecord | null
  onClose: () => void
}
...
export const ApplicationDetailModal: React.FC<ApplicationDetailModalProps> = ({
  ...
  const formattedDate = new Date(application.created_at).toLocaleString('en-US', {
    weekday: 'long',
    year: 'numeric',
    month: 'long',
    day: 'numeric',
        ...
        <div className="p-6 space-y-5 overflow-y-auto flex-1">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
              ...
              <p className="text-base font-extrabold text-slate-900">{application.company_name}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                ...
                <p className="text-sm font-bold text-slate-900">{application.mobile_number}</p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
              ...
              <p className="text-base font-extrabold text-emerald-700">
                {application.certification_required}
              </p>
            </div>
